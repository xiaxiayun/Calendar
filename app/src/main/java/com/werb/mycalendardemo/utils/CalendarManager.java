 ...
 * Holds reference to the days list of the calendar.保存对日历的日期列表的引用
 * As the app is using several views, we want to keep everything in one place.
 *由于应用程序使用了多个视图，我们希望将所有内容都放在一个地方。 
 *用于一些日历信息的管理
 */
public class CalendarManager {
    ...
    /**
     * List of days used by the calendar日历使用的天数列表
     * DayItem 集合
     */
    private List<DayItem> mDays = new ArrayList<>();
    /**
     * List of weeks used by the calendar日历使用的周的列表
     * WeekItem 集合
     */
    private List<WeekItem> mWeeks = new ArrayList<>();
    /**
     * List of months used by the calendar日历使用的月的列表
     * MonthItem 集合
     */
    private List<MonthItem> mMonths = new ArrayList<>();
    /**
     * List of events instances事件的列表
     * CalendarEvent 集合
     */
