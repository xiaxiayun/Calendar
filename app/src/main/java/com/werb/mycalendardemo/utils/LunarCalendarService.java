...
public class LunarCalendarService {
     ...
     *
     **/
    final static String[] lunarHoliday = new String[] { "0715 中元节","0909 重阳节","0101 春节", "0115 元宵节", "0505 端午节", "0707 七夕情人节",
            "0815 中秋节", "1208 腊八", "1224 小年", "0100 除夕"
    };
     ...
     *
     **/
    final static String[] solarHoliday = new String[] {"0101 元旦","0312 植树","0315 消费者权益日","0501 劳动", "0504 青年","0512 护士","0701 建党", "0801 建军",
            "0214 情人节", "0308 妇女节", "0401 愚人节", "0601 儿童节", "0910 教师节", "1001 国庆节", "1225 圣诞节",
    };
    // ====== 传回农历 y年的总天数
...
//    }
     ...
     *
     * isday: 这个参数为false---日期为节假日时，阴历日期就返回节假日（也会返回公历节日） ，true---不管日期是否为节假日依然返回这天对应的阴历日期
     *
     * @return
     */
    ...
    public static void main(String[] args) {
        System.out.println(new LunarCalendarService().getLunarDate(2018, 9, 10, false));
    }
