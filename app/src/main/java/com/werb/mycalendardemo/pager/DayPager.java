...
/**
 * Created by abc-pc on 2020/4/12.
 */
public class DayPager extends BasePager {
    ...
    public View initView() {
        View view = View.inflate(mActivity, R.layout.daypager_view, null);  //View.Inflate用于将xml中定义的布局控件找出来
    ...
    /**
     * 点击 CalendarView 选择不同的日期，可以选择日期的行程
     */
